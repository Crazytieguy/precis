...
- **Plain text fallback** — files in ~30 additional languages (C++, Java, Kotlin, Ruby, Swift, Zig, Dart, etc.) plus Makefile, Dockerfile, go.mod, and RST are included as plain text

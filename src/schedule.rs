...
pub struct GroupKey {
    ...
    /// Whether the file contains a "generated by" / "DO NOT EDIT" marker.
...
fn compute_value(group: &Group, stage: StageKind, n: usize) -> f64 {
    ...
    // Auto-generated files (mockery, protobuf, codegen) contain
    // machine-generated code that duplicates source-of-truth definitions.
    ...
    let base_value = visibility * documented * depth_factor
        ...
        * boilerplate_factor * autogen_api_doc_factor * generated_factor * reexport_factor;
